...
public class NovalnetInvoicePaymentServiceImpl implements PaymentService
{
    
    private final static String SERVICE_ID = "NOVALNET_INVOICE";
    ...
    public NovalnetInvoicePaymentServiceImpl(ServiceConfigurationBO serviceConfigurationBO)
    {
        redirectAfterCheckoutCapability = new NovalnetInvoiceRedirectAfterCheckoutCapabilityImpl(serviceConfigurationBO, this.SERVICE_ID);
