package com.intershop.adapter.payment.novalnet.internal.postfinance;
...
public class NovalnetPostfinancePaymentServiceImpl implements PaymentService
{
    
    private final static String SERVICE_ID = "NOVALNET_POSTFINANCE";
    ...
    public NovalnetPostfinancePaymentServiceImpl(ServiceConfigurationBO serviceConfigurationBO)
    {
        redirectAfterCheckoutCapability = new NovalnetPostfinanceRedirectAfterCheckoutCapabilityImpl(serviceConfigurationBO, this.SERVICE_ID);
