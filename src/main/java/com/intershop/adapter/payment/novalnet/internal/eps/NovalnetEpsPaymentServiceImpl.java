...
public class NovalnetEpsPaymentServiceImpl implements PaymentService
{
    
    private final static String SERVICE_ID = "NOVALNET_EPS";
    ...
    public NovalnetEpsPaymentServiceImpl(ServiceConfigurationBO serviceConfigurationBO)
    {
        redirectAfterCheckoutCapability = new NovalnetEpsRedirectAfterCheckoutCapabilityImpl(serviceConfigurationBO, this.SERVICE_ID);
