...
public class NovalnetGlobalConfigPaymentServiceDefinitionImpl extends NovalnetPaymentServiceDefinitionImpl
{
    @Override
    public ServiceProvider getServiceProvider(ServiceConfigurationBO serviceConfigurationBO)
    {
        return new PaymentServiceProvider(new NovalnetGlobalConfigPaymentServiceImpl(serviceConfigurationBO));
    }
}