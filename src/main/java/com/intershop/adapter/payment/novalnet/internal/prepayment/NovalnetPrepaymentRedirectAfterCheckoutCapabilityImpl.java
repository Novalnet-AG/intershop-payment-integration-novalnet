...
public class NovalnetPrepaymentRedirectAfterCheckoutCapabilityImpl implements RedirectAfterCheckout 
{
    ...
    public NovalnetPrepaymentRedirectAfterCheckoutCapabilityImpl(ServiceConfigurationBO serviceConfigurationBO, String serviceID)
    {
