...
public class NovalnetCreditcardPaymentServiceImpl implements PaymentService
{
    
    private final static String SERVICE_ID = "NOVALNET_CREDITCARD";
    ...
    public NovalnetCreditcardPaymentServiceImpl(ServiceConfigurationBO serviceConfigurationBO)
    {
        redirectAfterCheckoutCapability = new NovalnetCreditcardRedirectAfterCheckoutCapabilityImpl(serviceConfigurationBO, this.SERVICE_ID);
