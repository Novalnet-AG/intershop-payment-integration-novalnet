...
public class NovalnetTrustlyPaymentServiceImpl implements PaymentService
{
    
    private final static String SERVICE_ID = "NOVALNET_TRUSTLY";
    ...
    public NovalnetTrustlyPaymentServiceImpl(ServiceConfigurationBO serviceConfigurationBO)
    {
        redirectAfterCheckoutCapability = new NovalnetTrustlyRedirectAfterCheckoutCapabilityImpl(serviceConfigurationBO, this.SERVICE_ID);
