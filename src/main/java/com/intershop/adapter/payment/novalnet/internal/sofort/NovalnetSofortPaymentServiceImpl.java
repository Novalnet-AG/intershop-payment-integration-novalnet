...
public class NovalnetSofortPaymentServiceImpl implements PaymentService
{
    
    private final static String SERVICE_ID = "NOVALNET_SOFORT";
    ...
    public NovalnetSofortPaymentServiceImpl(ServiceConfigurationBO serviceConfigurationBO)
    {
        redirectAfterCheckoutCapability = new NovalnetSofortRedirectAfterCheckoutCapabilityImpl(serviceConfigurationBO, this.SERVICE_ID);
