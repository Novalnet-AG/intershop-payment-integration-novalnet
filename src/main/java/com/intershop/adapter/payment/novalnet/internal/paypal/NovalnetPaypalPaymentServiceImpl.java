package com.intershop.adapter.payment.novalnet.internal.paypal;
...
public class NovalnetPaypalPaymentServiceImpl implements PaymentService
{
    
    private final static String SERVICE_ID = "NOVALNET_PAYPAL";
    ...
    public NovalnetPaypalPaymentServiceImpl(ServiceConfigurationBO serviceConfigurationBO)
    {
        redirectAfterCheckoutCapability = new NovalnetPaypalRedirectAfterCheckoutCapabilityImpl(serviceConfigurationBO, this.SERVICE_ID);
