...
public class NovalnetPrzelewyPaymentServiceImpl implements PaymentService
{
    
    private final static String SERVICE_ID = "NOVALNET_PRZELEWY";
    ...
    public NovalnetPrzelewyPaymentServiceImpl(ServiceConfigurationBO serviceConfigurationBO)
    {
        redirectAfterCheckoutCapability = new NovalnetPrzelewyRedirectAfterCheckoutCapabilityImpl(serviceConfigurationBO, this.SERVICE_ID);
