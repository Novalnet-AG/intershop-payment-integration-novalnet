...
public class NovalnetSepaRedirectAfterCheckoutCapabilityImpl implements RedirectAfterCheckout 
{
    ...
    public NovalnetSepaRedirectAfterCheckoutCapabilityImpl(ServiceConfigurationBO serviceConfigurationBO, String serviceID)
    {
