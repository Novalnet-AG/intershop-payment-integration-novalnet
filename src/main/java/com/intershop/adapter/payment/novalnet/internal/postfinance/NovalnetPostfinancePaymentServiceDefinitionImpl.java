...
public class NovalnetPostfinancePaymentServiceDefinitionImpl extends NovalnetPaymentServiceDefinitionImpl
{
    @Override
    public ServiceProvider getServiceProvider(ServiceConfigurationBO serviceConfigurationBO)
    {
        return new PaymentServiceProvider(new NovalnetPostfinancePaymentServiceImpl(serviceConfigurationBO));
    }
}