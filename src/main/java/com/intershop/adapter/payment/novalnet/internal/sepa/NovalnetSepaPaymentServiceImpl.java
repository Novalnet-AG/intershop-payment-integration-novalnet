package com.intershop.adapter.payment.novalnet.internal.sepa;
...
public class NovalnetSepaPaymentServiceImpl implements PaymentService
{
    
    private final static String SERVICE_ID = "NOVALNET_SEPA";
    ...
    public NovalnetSepaPaymentServiceImpl(ServiceConfigurationBO serviceConfigurationBO)
    {
        redirectAfterCheckoutCapability = new NovalnetSepaRedirectAfterCheckoutCapabilityImpl(serviceConfigurationBO, this.SERVICE_ID);
