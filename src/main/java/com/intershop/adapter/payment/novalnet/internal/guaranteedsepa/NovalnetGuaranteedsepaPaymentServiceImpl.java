package com.intershop.adapter.payment.novalnet.internal.guaranteedsepa;
...
public class NovalnetGuaranteedsepaPaymentServiceImpl implements PaymentService
{
    
    private final static String SERVICE_ID = "NOVALNET_GUARANTEEDSEPA";
    ...
    public NovalnetGuaranteedsepaPaymentServiceImpl(ServiceConfigurationBO serviceConfigurationBO)
    {
        redirectAfterCheckoutCapability = new NovalnetGuaranteedsepaRedirectAfterCheckoutCapabilityImpl(serviceConfigurationBO, this.SERVICE_ID);
