...
public class NovalnetMultibancoPaymentServiceImpl implements PaymentService
{
    
    private final static String SERVICE_ID = "NOVALNET_MULTIBANCO";
    ...
    public NovalnetMultibancoPaymentServiceImpl(ServiceConfigurationBO serviceConfigurationBO)
    {
        redirectAfterCheckoutCapability = new NovalnetMultibancoRedirectAfterCheckoutCapabilityImpl(serviceConfigurationBO, this.SERVICE_ID);
