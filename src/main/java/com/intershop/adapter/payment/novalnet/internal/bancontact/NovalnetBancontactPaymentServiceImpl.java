...
public class NovalnetBancontactPaymentServiceImpl implements PaymentService
{
    
    private final static String SERVICE_ID = "NOVALNET_BANCONTACT";
    ...
    public NovalnetBancontactPaymentServiceImpl(ServiceConfigurationBO serviceConfigurationBO)
    {
        redirectAfterCheckoutCapability = new NovalnetBancontactRedirectAfterCheckoutCapabilityImpl(serviceConfigurationBO, this.SERVICE_ID);
