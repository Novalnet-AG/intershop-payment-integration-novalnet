package com.intershop.adapter.payment.novalnet.internal.cashpayment;
...
public class NovalnetCashpaymentPaymentServiceImpl implements PaymentService
{
    
    private final static String SERVICE_ID = "NOVALNET_CASHPAYMENT";
    ...
    public NovalnetCashpaymentPaymentServiceImpl(ServiceConfigurationBO serviceConfigurationBO)
    {
        redirectAfterCheckoutCapability = new NovalnetCashpaymentRedirectAfterCheckoutCapabilityImpl(serviceConfigurationBO, this.SERVICE_ID);
