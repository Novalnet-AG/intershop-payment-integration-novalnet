...
public class NovalnetBancontactPaymentServiceDefinitionImpl extends NovalnetPaymentServiceDefinitionImpl
{
    @Override
    public ServiceProvider getServiceProvider(ServiceConfigurationBO serviceConfigurationBO)
    {
        return new PaymentServiceProvider(new NovalnetBancontactPaymentServiceImpl(serviceConfigurationBO));
    }
}