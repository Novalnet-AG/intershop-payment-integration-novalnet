...
public class NovalnetTrustlyRedirectAfterCheckoutCapabilityImpl implements RedirectAfterCheckout 
{
    ...
    public NovalnetTrustlyRedirectAfterCheckoutCapabilityImpl(ServiceConfigurationBO serviceConfigurationBO, String serviceID)
    {
