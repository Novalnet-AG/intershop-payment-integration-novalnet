...
public class NovalnetMultibancoRedirectAfterCheckoutCapabilityImpl implements RedirectAfterCheckout 
{
    ...
    public NovalnetMultibancoRedirectAfterCheckoutCapabilityImpl(ServiceConfigurationBO serviceConfigurationBO, String serviceID)
    {
