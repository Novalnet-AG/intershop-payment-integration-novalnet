...
public class NovalnetIdealPaymentServiceImpl implements PaymentService
{
    
    private final static String SERVICE_ID = "NOVALNET_IDEAL";
    ...
    public NovalnetIdealPaymentServiceImpl(ServiceConfigurationBO serviceConfigurationBO)
    {
        redirectAfterCheckoutCapability = new NovalnetIdealRedirectAfterCheckoutCapabilityImpl(serviceConfigurationBO, this.SERVICE_ID);
