package com.intershop.adapter.payment.novalnet.internal.bancontact;
...
public class NovalnetBancontactRedirectAfterCheckoutCapabilityImpl implements RedirectAfterCheckout 
{
    ...
    public NovalnetBancontactRedirectAfterCheckoutCapabilityImpl(ServiceConfigurationBO serviceConfigurationBO, String serviceID)
    {
    ...
    { 
        ...
        if(status.equalsIgnoreCase("FAILURE") || NovalnetUtil.nnIsEmpty(urlCreationResult.get("redirect_url"))) {
    ...
    public URI calculateRedirectURL(PaymentContext arg0, Payable arg1, URI arg2, URI arg3, URI arg4)
    {
        return null;
    }
