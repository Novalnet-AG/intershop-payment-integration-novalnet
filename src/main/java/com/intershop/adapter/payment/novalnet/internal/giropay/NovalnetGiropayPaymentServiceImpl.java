package com.intershop.adapter.payment.novalnet.internal.giropay;
...
public class NovalnetGiropayPaymentServiceImpl implements PaymentService
{
    
    private final static String SERVICE_ID = "NOVALNET_GIROPAY";
    ...
    public NovalnetGiropayPaymentServiceImpl(ServiceConfigurationBO serviceConfigurationBO)
    {
        redirectAfterCheckoutCapability = new NovalnetGiropayRedirectAfterCheckoutCapabilityImpl(serviceConfigurationBO, this.SERVICE_ID);
