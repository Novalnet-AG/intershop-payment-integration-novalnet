...
public class NovalnetBanktransferPaymentServiceImpl implements PaymentService
{
    
    private final static String SERVICE_ID = "NOVALNET_BANKTRANSFER";
    ...
    public NovalnetBanktransferPaymentServiceImpl(ServiceConfigurationBO serviceConfigurationBO)
    {
        redirectAfterCheckoutCapability = new NovalnetBanktransferRedirectAfterCheckoutCapabilityImpl(serviceConfigurationBO, this.SERVICE_ID);
