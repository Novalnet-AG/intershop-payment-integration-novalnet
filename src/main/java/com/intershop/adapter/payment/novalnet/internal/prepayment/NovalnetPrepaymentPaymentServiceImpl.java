...
public class NovalnetPrepaymentPaymentServiceImpl implements PaymentService
{
    
    private final static String SERVICE_ID = "NOVALNET_PREPAYMENT";
    ...
    public NovalnetPrepaymentPaymentServiceImpl(ServiceConfigurationBO serviceConfigurationBO)
    {
        redirectAfterCheckoutCapability = new NovalnetPrepaymentRedirectAfterCheckoutCapabilityImpl(serviceConfigurationBO, this.SERVICE_ID);
